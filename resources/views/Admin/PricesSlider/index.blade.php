...
@section('title')
    {{$setting->title}} | PRICES & OPENING HOURS
@endsection
@section('page_name') PRICES & OPENING HOURS @endsection
@section('css')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{$setting->title}} PRICES & OPENING HOURS</h3>
                    <div class="">
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('pricesSlider.index')}}', columns);
        deleteScript('{{route('pricesSlider.delete')}}');
        ...
        $(document).on('click', '.addBtn', function () {
            ...
            setTimeout(function () {
                $('#modalContent').load('{{route('pricesSlider.create')}}')
            }, 250)
        });
